 ...
 *---------------------------------------------------------------------------
 * 라이브러리  :                                                             
 * 작  성  자  : 강영익 (E-mail:myjunu@gmail.com , facebook: myjunu@gmail.com)
 * 헤더  화일  : trash.h
 ...
 *    +--------+------------------------------------------------------+------
 *    |98. 3. 5| 화일의 mode, 생성일자 출력 추가                      |강영익
 *    |98. 3.25| 화일의 mode로 화일을 복구                            |강영익
 *    |98. 5.13| '.'이 없는 화일명 삭제시 에러 수정                   |강영익
 *    |02. 6. 7| 환경변수를 실행할 때 전역변수에 저장한 후 사용       |강영익
 *    |17. 8.17| 윈도우 크기 변경에 따른 UI 가변적으로 변화도록 함    |강영익
 *    |17. 8.18| 윈도우 크기 정의한 데이터형 변경(char --> int)       |강영익
 *    |17. 8.18| OSX에서 사용되도록 trash폴더명 변경                  |강영익
 *----+--------+------------------------------------------------------+------
 *  컴파일   :                                                               
 *                                                                           
 *     cc -o trash trash.c                                                   
